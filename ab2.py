...
imfile.save(r"C:\Users\Muhammad\PycharmProjects\abc\myImages\result_bw.png")
print("Image binarization...Done")

#Remove Backgroud
# img_name = Image.open('result_bw.png')#image path and name
img_name = Image.open(r"C:\Users\Muhammad\PycharmProjects\abc\myImages\result_bw.png")#image path and name
...
img_name.save(r"C:\Users\Muhammad\PycharmProjects\abc\myImages\TransparentImage.png", "PNG")#converted Image name
...
img = Image.open(r"C:\Users\Muhammad\PycharmProjects\abc\myImages\TransparentImage.png")

wpercent = (basewidth/float(img.size[0]))
hsize = int((float(img.size[1])*float(wpercent)))
img = img.resize((basewidth,hsize), Image.ANTIALIAS)
img.save(r"C:\Users\Muhammad\PycharmProjects\abc\myImages\resizedImage.png")
print("Image resizing...Done")

# img_name = "resizedImage.png";
img_name = r"C:\Users\Muhammad\PycharmProjects\abc\myImages\resizedImage.png"
